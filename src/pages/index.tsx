...
import AnswerWorksheetImage from "public/images/features/answer-worksheet.png";
import CheckWorksheetImage from "public/images/features/check-worksheet.png";
...
const FeatureSection = () => {
  const features = [
    {
      text: "Create and edit your worksheet",
      image: EditWorksheetImage,
    },
    {
      text: "Automatically generate explanation using AI",
      image: GenerateExplanationImage,
    },
    {
      text: "Publish and share your worksheet",
      image: ShareWorksheetImage,
    },
    {
      text: "The students will answer the worksheet",
      image: AnswerWorksheetImage,
    },
    {
      text: "Automatically grade the worksheets and give personalized feedback using AI",
      image: CheckWorksheetImage,
    },
  ];
          ...
          {features.map((feature, index) => {
            return (
              <div
                key={feature.text}
                className={cn(
                  "flex w-full cursor-pointer justify-start rounded-lg px-4 py-4 transition-all hover:bg-accent hover:text-accent-foreground active:bg-blue-100 dark:active:bg-sky-950/60",
                  feature.text == currentFeature?.text && "bg-accent"
                )}
                onClick={() => {
                  setCurrentFeature(feature);
                }}
              >
                <span className="mr-2 align-top">{index + 1}.</span>
                {feature.text}
              </div>
            );
          })}
